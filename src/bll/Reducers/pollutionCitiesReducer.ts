...
const SET_CITIES_FROM_SEARCH: "pollutionCitiesReducer/SET_CITIES_FROM_SEARCH" =
  "pollutionCitiesReducer/SET_CITIES_FROM_SEARCH";
const SET_FETCHING: "pollutionCitiesReducer/SET_FETCHING" =
  "pollutionCitiesReducer/SET_FETCHING";
...
type Action = SetFetching | SetCitiesFromSearch | SetClearestCities;

export const pollutionCitiesReducer = (
  state = initialState,
  action: Action
): InitialState => {
  switch (action.type) {
...
export const setClearestCities = (
  clearestCities: City[]
): SetClearestCities => {
  return {
...
export const setCitiesFromSearch = (
  citiesFromSearch: City[]
): SetCitiesFromSearch => {
  return {
...
export const setClearestCitiesByCountryId =
  (countryId: string): Thunk =>
  async (dispatch: Dispatch) => {
    try {
